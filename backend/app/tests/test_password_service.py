...
class TestPasswordService(unittest.TestCase):
    ...
    @patch('app.services.password_service.get_cached_parameter')
    ...
    @patch('app.services.password_service.initiate_password_reset')
    @patch('app.services.password_service.logger')
    ...
    @patch('app.services.password_service.complete_password_reset')
    @patch('app.services.password_service.logger')
